#!/usr/bin/env python3
"""Generate vaq_relerr_plots2.ipynb with LSQ++-style VAQ plotting logic."""
...
NOTEBOOK = Path(__file__).with_name("vaq_relerr_plots2.ipynb")
...
'''
    ...
    code(
        r'''def load_vaq_data(data_dir: Path = DATA_DIR) -> pd.DataFrame:
