...
int main(int argc, char **argv) {
  ...
  RowMatrixXf trainset = RowMatrixXf::Zero(args.at<int>("trainset-size"), args.at<int>("timeseries-size") + dimPadding);
  {
    ...
    std::cout << "Read trainset" << std::endl;
    if (args["file-format-ori"] == "ascii") {
      readOriginalFromExternal<true>(args["trainset"], trainset, args.at<int>("timeseries-size"), ',');
    } else if (args["file-format-ori"] == "fvecs") {
      readFVecsFromExternal(args["trainset"], trainset, args.at<int>("timeseries-size"), args.at<int>("trainset-size"));
    } else if (args["file-format-ori"] == "bvecs") {
      readBVecsFromExternal(args["trainset"], trainset, args.at<int>("timeseries-size"), args.at<int>("trainset-size"));
    } else if (args["file-format-ori"] == "bin") {
